...
const char ssid[] = "Chela"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Chela#123456"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "3.83.237.33"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
const char MQTT_TOPIC_PUB[] = "chile/ohiggins/santacruz/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "chile/ohiggins/santacruz/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
...
void receivedCallback(char* topic, byte* payload, unsigned int length) {
  ...
  if (data.indexOf("T_MAX") >= 0 || data.indexOf("H_MAX") >= 0) {
    display.clearDisplay();
